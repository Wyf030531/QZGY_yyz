...
更新规则：凡属于“2针阔叶混交林”的像元重分类为 2，属于“1针叶林”的重分类为 1，属于“3阔叶林”的重分类为 3，属于“7草丛”“6草原”或“8草甸”的统一合并重分类为 4；
属于“4灌丛”时，不再统一归为单一灌丛类，也不再并入针叶林或阔叶林，而是根据“植被亚类”进一步细分：亚类为“(24)亚高山常绿针叶灌丛”的重分类为 8，即针叶灌木；
亚类为“(18)温带落叶灌丛”“(19)亚热带、热带常绿阔叶、落叶阔叶灌丛（常含稀树）”“(21)亚热带、热带旱生常绿肉质多刺灌丛”“(22)亚高山落叶阔叶灌丛”“(23)亚高山硬叶常绿阔叶灌丛”的重分类为 5，即阔叶灌木；
...
def build_reclass_map_from_excel(excel_file):
    ...
    for row in ws.iter_rows(min_row=2, values_only=True):
        ...
        # 5. 灌丛：根据亚类细分为阔叶灌木和针叶灌木
            ...
            # 若是灌丛但亚类没识别到，可默认归入阔叶灌木
            # 若你希望改成 0，也可以改成 new_class = 0
            else:
                new_class = 5
